...
var $author$project$PVMainSvg$extractFields = F2(
	function (pairs, noteSoFar) {
		extractFields:
		while (true) {
			var _v0 = $elm$core$List$head(pairs);
			if (_v0.$ === 'Just') {
				var aTuple = _v0.a;
				var _v1 = aTuple.a;
				switch (_v1) {
...
var $author$project$PVMainSvg$renderPostIt = function (pair) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('postIt'),
				A2(
...
var $author$project$PVMainSvg$renderPostIts3 = F3(
	function (renderedSoFar, pairs, xy) {
		...
		while (true) {
			if (pairs.b) {
				var firstPair = pairs.a;
				var restOfPairs = pairs.b;
